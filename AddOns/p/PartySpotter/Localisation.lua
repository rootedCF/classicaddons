...
PSPOT_HELP_TEXT4  = "|cff00ff00Use |r|cffffffff/pspot < 1 - 9 >|r|cff00ff00 to turn PartySpotter On and change the Map Update delay to any number of seconds between 1 and 9|r";
...
PSPOT_HELP_TEXT12 = "|cff00ff00Use |r|cffffffff/pspot reset|r|cff00ff00 to restore defaults|r";
