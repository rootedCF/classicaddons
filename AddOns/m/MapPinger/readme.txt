  ...
  players who **spaming** ping on raids or Battlegrounds.

  About install: copy MapPinger folder to Interface folder

  About remove: delete MapPinger folder from Interface folder
...
--
  [EU.Warsong] Fea < X > [inferno@bugz.ru]